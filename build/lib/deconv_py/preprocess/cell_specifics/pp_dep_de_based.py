...
class PpDepDeBased(TransformerMixin,BaseEstimator):
    ...
    def transform(self, data, *_):
        ...
        genes = self.get_sig_genes(per_cell_de, list_of_cells,possible_genes,mapp_genes_idx)

        return [_A.loc[genes], _B.loc[genes]]
    ...
    def get_sig_genes(self,per_cell_de, list_of_cells,possible_genes,mapp_genes_idx, n_of_genes=15):
        all_genes_list = []
