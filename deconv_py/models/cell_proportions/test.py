...
class Test(DeconvolutionModel):
    def __init__(self, normalize = True,cellMix = False,em_optimisation = False,weight_sp=True):
        self.cellMix =cellMix
        self.cmc = CellMixCoordinator()

        DeconvolutionModel.__init__(self, normalize = normalize,em_optimisation = em_optimisation,weight_sp = weight_sp)
